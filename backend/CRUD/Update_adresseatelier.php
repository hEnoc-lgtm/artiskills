...
try {
    ...
    if ($stmt->rowCount() === 0) {
        ...
        echo json_encode(["success" => false, "message" => "Adresse d'atelier introuvable ou aucune modification effectuée."]);
        exit;
    }

    echo json_encode(["success" => true, "message" => "Adresse d'atelier mise à jour avec succès."]);
