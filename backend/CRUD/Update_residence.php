...
try {
    ...
    if ($stmt->rowCount() === 0) {
        ...
        echo json_encode(["success" => false, "message" => "Résidence introuvable ou aucune modification effectuée."]);
        exit;
    }

    echo json_encode(["success" => true, "message" => "Résidence mise à jour avec succès."]);
